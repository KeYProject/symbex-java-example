    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            KeYEnvironment<DefaultUserInterfaceControl> env =
                    KeYEnvironment.load(SymbolicExecutionJavaProfile.getDefaultInstance(), location, classPaths,
                            bootClassPath, includes, true);
            ...
            try {
                ...
                AbstractOperationPO po = new ProgramMethodPO(env.getInitConfig(),
                        ...
                        true); // Needs to be true for symbolic execution!
                // po = new ProgramMethodSubsetPO(...); // PO for symbolic execution of some statements
                // within a method (Java semantics)
                ...
                builder.analyse();
                // Optionally, create an SymbolicExecutionEnvironment which provides access to all relevant
                // objects for symbolic execution
                ...
                IBreakpoint breakpoint = new ExceptionBreakpoint(proof, "java.lang.NullPointerException",
